...
$(function () {
    ...
    //   $( "#github-stars" ).html( data.stargazers_count );
    // });
    $.get( "https://api.github.com/repos/rflavien/iothing/commits", function( data ) {
      $( "#github-lastCommit" ).html( new Date(data[0].commit.committer.date).toDateString() );
    });
